...
const cosmosdb: Schema<cosmosdb> = {
  cosmosdb_account_endpoint: {
    ...
    env: "COSMOCLI_COSMOSDB_ACCOUNT_ENDPOINT",
  },
  ...
  cosmosdb_reject_unauthorized: {
    ...
    env: "COSMOCLI_COSMOSDB_REJECT_UNAUTHORIZED",
  },
  cosmosdb_use_keyvault: {
    ...
    env: "COSMOCLI_COSMOSDB_USE_KEYVAULT",
  },
};
...
const keyvault_cosmosdb: Schema<keyvault_cosmosdb> = {
  cosmosdb_endpoint_secret_name: {
    ...
    env: "COSMOCLI_COSMOSDB_ENDPOINT_SECRET_NAME",
  },
  cosmosdb_key_secret_name: {
    ...
    env: "COSMOCLI_COSMOSDB_KEY_SECRET_NAME",
    sensitive: true,
  },
};
...
const keyvault_storage_account: Schema<keyvault_storage_account> = {
  storage_account_name_secret_name: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_NAME_SECRET_NAME",
  },
  storage_account_key_secret_name: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_KEY_SECRET_NAME",
    sensitive: true,
  },
};
...
const azure_storage_account: Schema<azure_storage_account> = {
  ...
  storage_account_prefix: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_PREFIX",
  },
  storage_account_suffix: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_SUFFIX",
  },
  storage_account_delimiter: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_DELIMITER",
  },
  storage_account_protocol: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_PROTOCOL",
  },
  storage_account_connectionstring_suffix: {
    ...
    env: "COSMOCLI_STORAGE_ACCOUNT_CONNECTIONSTRING_SUFFIX",
  },
...
const filesystem: Schema<filesystem> = {
  ...
  filesystem_prefix: {
    ...
    env: "COSMOCLI_FILESYSTEM_PREFIX",
  },
  filesystem_suffix: {
    ...
    env: "COSMOCLI_FILESYSTEM_SUFFIX",
  },
  filesystem_delimiter: {
    ...
    env: "COSMOCLI_FILESYSTEM_DELIMITER",
  },
};
